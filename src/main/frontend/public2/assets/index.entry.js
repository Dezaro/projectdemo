...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "module.exports",
	  render: function() {
	    return (
	      React.createElement("div", {className: "mainContainer", style: mainContainerStyle}, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "module.exports",
	  render: function() {
	    ...
	    return (
	      React.createElement("div", {className: "navBar", style: navBarStyle}, 
	        React.createElement("ul", {style: navMenuStyle}, 
	          React.createElement("li", {style: {display: 'inline'}}, 
	            React.createElement("a", {href: "./index.html", style: navBulletStyle}, 
	              "HOME"
	            )
	          ), 
	          React.createElement("li", {style: {display: 'inline'}}, 
	            React.createElement("a", {href: "", style: navBulletStyle}, 
	              "ABOUT"
	            )
	          ), 
	          React.createElement("li", {style: {display: 'inline'}}, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HeadingSite = __webpack_require__(162);
	  ...
	  render: function() {
	    return (
	      React.createElement("div", {className: "header", style: headerStyle}, 
	        React.createElement(HeadingSite, null)
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "module.exports",
	  render: function() {
	    return (
	      React.createElement("div", {className: "headerContent", style: headingSiteStyle}, 
	        React.createElement("h1", {style: {fontSize: '80px'}}, 
	          "Clean Blog"
	        ), 
	        React.createElement("p", {style: {fontSize: '24px'}}, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PostList = __webpack_require__(164);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PostItem = __webpack_require__(165);
	...
	module.exports = React.createClass({displayName: "module.exports",
		...
		render: function() {
			var posts = this.state.data.map(function(post) {
				return (
					React.createElement(PostItem, {title: post["title"], date: post["date"], key: "key" + post["id"], id: post["id"]}, 
						post["summary"]
					)
				);
			});
		...
		render: function() {
			...
			return (
				React.createElement("div", {className: "post", style: postStyle}, 
					React.createElement("a", {href: "post.html", style: {textDecoration: 'none'}}, 
						React.createElement("h1", {className: "title", id: this.props.id}, 
							this.props.title
						), 
						this.props.children
					), 
					...
					React.createElement("p", {style: dateStyle}, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "module.exports",
		render: function() {
			return (
				React.createElement("div", {className: "pager", style: pagerStyle}, 
					React.createElement("a", {href: "", style: {textDecoration: 'none', color: 'black', float: 'right'}}, 
						"OLDER POSTS"
					)
				)
			);
